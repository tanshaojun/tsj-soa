...
public class HTMLFilter {
	...
	public static void main(String[] args) {
		//System.out.println("<img src=\"111\"/>dfdf<a href=\"111\" onclick=onclick=alert(1) href=\"javascript:alert(1)\">22233</a><plaintext><script type=\"javascript\">alert(123)</script><p onclick= '111'>111</p>");
		System.out
				.println(makeSafe("<img src=\"111\"/>dfdf<a href=\"111\" onclick=onclick=alert(1) href=\"javascript:alert(1)\">22233</a><plaintext><script type=\"javascript\">alert(123)</script><p onclick= '111'>111</p>"));
